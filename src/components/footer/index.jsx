const PRODUCTS = [
  {
    ...
    list: [
      {
        title: "Launchify",
        link: "https:// www.launchify.club?utm_source=boilercode",
      },
      { title: "VA360", link: "https://www.va360.club?utm_source=boilercode" },
    ],
  },
  {
    title: "Extensions",
    list: [
      {
        ...
        link: "https://chromewebstore.google.com/detail/screenshot-to-code/hjbpcilippgfjenlgigmpgfmookfohag?utm_source=boilercode",
      },
      {
        title: "Launchify",
        link: "https://chromewebstore.google.com/detail/launchify/peflongejpeiohocbimfcedepdphkohk?utm_source=boilercode",
      },
      {
        title: "Tweetify",
        link: "https://chromewebstore.google.com/detail/tweetify/dochhfmjdfbjejlajmpiimpgibocdfhj?utm_source=boilercode",
      },
    ],
  },
];
        ...
        <div className="py-8 border-b border-gray-100 lg:order-last lg:border-b-0 lg:border-l lg:py-16 lg:pl-16">
          <div className="block text-primary lg:hidden">
            <div className="flex items-center">
              ...
              <div className="text-2xl ml-2">Boilercode</div>
            </div>
          </div>
